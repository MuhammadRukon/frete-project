...
export default function FormHome() {
  ...
  const [accessibility1Error, setAccesibility1Error] = useState("");
  const [accessibilityError, setAccesibilityError] = useState("");
  ...
  const validateStep1 = () => {
    ...
    if (!selectedHouseType) {
      setHouseTypeError("Please select the type of house.");
      isValid = false;
    } else {
      setHouseTypeError("");
    }
    ...
    if (selectedAccessibility?.length < 1) {
      setAccesibility1Error("please select Acessibility");
      isValid = false;
    } else {
      setAccesibility1Error("");
    }
    ...
    // accessibility validate
    if (
      (selectedDestinationHouseOrApartment.selectedHouseType === "House" ||
      ...
      if (!selectedDestinationHouseOrApartment.selectedAccessibility) {
        setAccesibilityError("Please select Accessiblity");
      }
      isValid = false;
    } else {
      setAccesibilityError("");
    }
  ...
  const validateStep2 = () => {
    ...
    if (!dataObj.preferedTimeForMoving) {
      setPreferedTimeError("Please select a preferred time for the move.");
      isValid = false;
    } else {
    ...
    if (!dataObj.restrictionOrFees) {
      setRestrictionOrFeesError(
        "Please indicate if there are restrictions or fees."
      );
      isValid = false;
    } else {
      setRestrictionOrFeesError("");
    ...
    if (!dataObj.needMovingCompany) {
      setNeedMovingCompanyError(
        "Please indicate if you need a moving company to pack the items."
      );
      isValid = false;
    } else {
      setNeedMovingCompanyError("");
  ...
  // Implement your email validation logic here, for example, using regex
  const isValidEmail = (email) => {
    const regexEmail = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
    return regexEmail.test(email);
  };

  // Implement your phone number validation logic here, for example, using regex
  const isValidPhone = (phone) => {
    // Implement your phone number validation logic here, for example, using regex
    const regexPhone = /^\d{10}$/; // Example: 1234567890 (10 digits)
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <div className="form-heading">
                What is the origin of the move?
              </div>
            </Grid>
            <Grid item xs={6}>
              <SelectBox
            ...
            {selectedFloor === "Specific Floor" && (
              <Grid item xs={12}>
                <InputField
                  label="Inform the Floor Number"
                  placeholder="Inform the Floor Number"
                  value={floorNumber}
            ...
            <Grid item xs={12}>
              <div className="form-heading">
                What is the destination of the move?
              </div>
            </Grid>
            <Grid item xs={6}>
              <SelectBox
            ...
            <Grid item xs={12}>
              <div className="form-heading">What is the date of the move?</div>
            </Grid>
            <Grid item xs={12}>
                ...
                <DatePicker
                  ...
                  helperText={
                    !isDateValid(dayjs(selectedDate))
                      ? "The date cannot be more than 90 days from the request date."
                      : ""
                  }
                  sx={{
                    width: "100%",
              ...
              {selectDateError.length === 0 ? (
                ...
                >
                  Attention: the maximum date for the move is within 90 days
                  from today.
                </div>
              ) : (
                <div
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              ...
              <CheckBox
                ...
                label="Is there any preferred time for the move?"
                showQual={true}
              ...
              <CheckBox
                ...
                label="Are there any restrictions or fees for traffic or parking in front of one of the addresses?"
              />
              <div
                style={{
                  width: "100%",
              ...
              <CheckBox
                ...
                label="Do you need the moving company to pack any items for you?"
              />
              <div
                style={{
                  width: "100%",
              ...
              <CheckBox
                ...
                label="Is there a need for furniture disassembly and assembly?"
              />
              <div
                style={{
                  width: "100%",
            ...
            <Grid item xs={12}>
              ...
              >
                ...
                <button
                  ...
                  } text-white rounded-md font-bold h-[45px]`}
                  disabled={disabled}
                  onClick={submitData}
                >
            ...
            <Grid item xs={12}>
              <div style={{ textAlign: "center" }}>
                ...
                <div className="form-success-content">
                  Your order number is <div>{displayOrderId}</div>
                </div>
                <img
